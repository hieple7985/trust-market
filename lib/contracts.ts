...
export const CONTRACTS = {
  AI_ORACLE: (process.env.NEXT_PUBLIC_AIORACLE_ADDRESS || '0x0000000000000000000000000000000000000000') as `0x${string}`,
  UMA_ADAPTER: (process.env.NEXT_PUBLIC_UMA_ADAPTER_ADDRESS || '0x0000000000000000000000000000000000000000') as `0x${string}`,
};
...
export const AI_ORACLE_ABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'livenessPeriod', type: 'uint256' },
    ],
    name: 'MarketCreated',
    type: 'event',
  },
